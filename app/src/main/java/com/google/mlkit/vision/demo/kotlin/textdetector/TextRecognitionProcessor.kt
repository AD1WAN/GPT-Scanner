...
class TextRecognitionProcessor(
  ...
  constructor(context: Context,
              textRecognizerOptions: TextRecognizerOptionsInterface,textForChatGptCallback: TextForChatGptCallback) :
          this(context, textRecognizerOptions) {
    this.textForChatGptCallback = textForChatGptCallback
  }

  private lateinit var textForChatGptCallback: TextForChatGptCallback
  ...
  interface TextForChatGptCallback {
    fun sendToActivity(receivedTextFromImage: String)
  }
}
